...
def parse_option():
    ...
    parser.add_argument("--n-layers", type=int, help="Model layers.")
    parser.add_argument("--n-heads", type=int, help="Model heads.")
    parser.add_argument("--norm-eps", type=float, help="LayerNorm epsilon.")
    parser.add_argument("--patch-grid", type=int, help="Patch grid.")
